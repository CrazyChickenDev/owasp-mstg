...
Using a proxy breaks SSL certificate verification and the app will usually fail
...
When both the client and server are controlled by the same organization and used
