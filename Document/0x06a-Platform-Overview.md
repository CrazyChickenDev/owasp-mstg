...
A developer profile and an Apple-signed certificate are required to deploy and
...
A language.lproj folder exists for each language that the application supports.
